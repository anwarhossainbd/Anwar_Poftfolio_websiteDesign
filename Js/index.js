...
gsap.from(".hero h1", { opacity: 0, duration: 1, delay: 1.0, y: -100 });
gsap.from(".hero p", { opacity: 0, duration: 1, delay: 1.5, x: -100 });
gsap.from(".hero .btn1", { opacity: 0, duration: 1, delay: 2.0, x: -20 });
gsap.from(".hero .btn2", { opacity: 0, duration: 1, delay: 2.0, x: 20 });
gsap.from(".nav-item", {
    opacity: 0,
    duration: 1,
    delay: 1.2,
